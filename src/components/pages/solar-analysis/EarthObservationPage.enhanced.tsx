...
import { nasaService } from "@/lib/api/solar-api"
...
export function EarthObservationPage({ onToggleSidebar }: EarthObservationPageProps) {
  ...
  const [, setIsLoadingSolar] = useState(false)
                  ...
                  <Card className="border-2 border-[#FFD60A]">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="p-4 bg-linear-to-br from-[#FFD60A]/10 to-[#FF9F1C]/10 rounded-lg">
                        ...
                        <div className="p-4 bg-linear-to-br from-[#FF6B6B]/10 to-[#FF8E53]/10 rounded-lg">
                          <p className="text-sm text-muted-foreground mb-1 flex items-center">
                        ...
                        <div className="p-4 bg-linear-to-br from-[#4ECDC4]/10 to-[#44A08D]/10 rounded-lg">
                          <p className="text-sm text-muted-foreground mb-1 flex items-center">
                        ...
                        <div className="p-4 bg-linear-to-br from-[#6A67CE]/10 to-[#FCB5AC]/10 rounded-lg">
                          <p className="text-sm text-muted-foreground mb-1 flex items-center">
